...
@Service
public class GetIntermediateResultsTransactionAllServiceImpl implements GetIntermediateResultsTransactionAllService {

    @Autowired
    private IntermediateResultsTransactionRepository intermediateResultsTransactionRepository;

    @Transactional(readOnly = true)
    public List<IntermediateResultsTransaction> findAllIntermediateResultsTransactions() {
        return intermediateResultsTransactionRepository.findAll();
    }
